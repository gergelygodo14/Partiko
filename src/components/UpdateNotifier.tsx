...
export default function UpdateNotifier() {
  ...
  return (
    <button
      ...
      className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2 z-50 bg-ink text-white text-sm px-4 py-3 rounded-full shadow-lg border-4 border-gold flex items-center gap-2"
    >
